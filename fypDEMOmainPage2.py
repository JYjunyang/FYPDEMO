...
class fypMenu:
    ...
    tb2Label2= Label(theRealTab2, text="Word2Vec Vectors Visualize", font=8)
    ...
    tb3Label = Label(theRealTab3, text="It's the final step! Press the button below to get the "
                     +"accuracy of each model:\n Please take note: Data will be splitted into 80% for training "
                     +"and 20% for testing by default.\n(Validation set will be adjusted accordingly from training set)", font=8)
    ...
    def hyperparameterTuningAndEvaluating(self, X_train, X_test, y_train, y_test):
        ...
        piechart.pie([positiveCount,negativeCount,neutralCount],
                     labels=['positive','negative','neutral'], startangle=90,
                     autopct='%.2f%%')
        piechart.set_title('Original Sentiment Score', bbox={'facecolor':'0.8', 'pad':5})
